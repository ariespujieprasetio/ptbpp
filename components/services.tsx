        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
          {services.map(({ icon: Icon, title, description }) => (
            ...
            >
              ...
              <Link href="#contact" className="mt-6 flex items-center gap-2 text-sm font-semibold text-[#E30613] after:absolute after:inset-0" aria-label={`Konsultasikan layanan ${title}`}>
                Selengkapnya
